...
#define TEMP_SENSOR_SOC 0 || In MRiscoC  
#define DEFAULT_FEEDRATE_MM_M (50*60) || In MRiscoC  

Z_HOMING_HEIGHT vs Z_CLEARANCE_FOR_HOMING
Z_MIN_ENDSTOP_INVERTING vs Z_MIN_ENDSTOP_HIT_STATE
...
#define STR(x) STR_HELPER(x)
  ...
  #define STRING_CONFIG_H_AUTHOR "FocusTorn" // Who made the changes.
...
#ifndef MOTHERBOARD
    #define MOTHERBOARD BOARD_CREALITY_V24S1_301F4	//[MDS]
#endif
 ...
 */
#define BAUDRATE 115200	//[MDS]
//#define BAUDRATE 250000 	//[MDS?]
#define BAUD_RATE_GCODE     //[MDS] Enable G-code M575 to set the baud rate
...
//#define BAUDRATE_3 250000   // :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE
  ...
  #define LCD_SERIAL_PORT 2 	// [MDS]
  #define LCD_BAUDRATE 115200	// [MDS]
// Enable the Bluetooth serial interface on AT90USB devices
//#define BLUETOOTH

// Name displayed in the LCD "Ready" message and Info menu
  #define CUSTOM_MACHINE_NAME "E3S1Pro"	// [MDS]
 ...
 */
#define X_DRIVER_TYPE  TMC2208_STANDALONE	// [MDS]
#define Y_DRIVER_TYPE  TMC2208_STANDALONE	// [MDS]
#define Z_DRIVER_TYPE  TMC2208_STANDALONE	// [MDS]
#define E0_DRIVER_TYPE TMC2208_STANDALONE	// [MDS]
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 20.28 // [MDS]
    #define DEFAULT_Ki 2.30 // [MDS]
    #define DEFAULT_Kd 44.61 // [MDS]
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 121.19	//[MDS]
  #define DEFAULT_bedKi 22.61	//[MDS]
  #define DEFAULT_bedKd 433.05	//[MDS]
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  //#define PID_EDIT_MENU      	  //[MDS] Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
  //#define PID_AUTOTUNE_MENU     //[MDS] Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define EXTRUDE_MINTEMP 180  	//[MDS]
...
#define X_MIN_ENDSTOP_HIT_STATE LOW		//[MDS?]
#define X_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define Y_MIN_ENDSTOP_HIT_STATE LOW		//[MDS?]
#define Y_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define Z_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define Z_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define I_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define I_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define J_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define J_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define K_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define K_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define U_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define U_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define V_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define V_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define W_MIN_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define W_MAX_ENDSTOP_HIT_STATE HIGH	//[MDS?]
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH	//[MDS?]
...
//#define DEFAULT_FEEDRATE_MM_M (50*60) 	//[MDS]
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  	//[MDS]
 ...
 *                and a minimum Z_SAFE_HOMING of 10.
 */
...
#define Z_PROBE_FEEDRATE_FAST (16*60) 	//[MDS]
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   5 // Z Clearance for Deploy/Stow 	//[MDS]
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points 	//[MDS]
...
#define Z_MIN_PROBE_REPEATABILITY_TEST	//{MDS}
...
#define AUTO_BED_LEVELING_BILINEAR	//[MDS]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 5 // (mm) Default fade height. 	//[MDS]
  #endif
   ...
   */
  #define G26_MESH_VALIDATION		//[MDS]
  ...
  #define GRID_MAX_POINTS_X 5	//[MDS]
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID	//[MDS]

    //
    // Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION	//[MDS]
    #if ENABLED(ABL_BILINEAR_SUBDIVISION)
      // Number of subdivisions between probe points
      #define BILINEAR_SUBDIVISIONS 5	//[MDS]
    #endif
...
#define LCD_BED_TRAMMING 	//[MDS]
  ...
  #define BED_TRAMMING_USE_PROBE	//[MDS]
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.1  // (mm) 	//[MDS]
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (10*60) }	//[MDS]
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501	//[MDS]
...
//
  ...
  #define PREHEAT_1_TEMP_HOTEND 215	//[MDS]
  #define PREHEAT_1_TEMP_BED     60
  #define PREHEAT_1_TEMP_CHAMBER 35
  #define PREHEAT_1_FAN_SPEED    255 // Value from 0 to 255	//[MDS]

  #define PREHEAT_2_LABEL       "ABS"
  #define PREHEAT_2_TEMP_HOTEND 240
  #define PREHEAT_2_TEMP_BED    110	//[MDS]
  #define PREHEAT_2_TEMP_CHAMBER 35
  #define PREHEAT_2_FAN_SPEED    255 // Value from 0 to 255	//[MDS]
 ...
 */
#define NOZZLE_PARK_FEATURE	//[MDS] [OP]

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MAX_POS -5), (Y_MAX_POS - 5), 30 }	//[MDS]
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   10   // (mm) Always raise Z by at least this distance	//[MDS]
  #define NOZZLE_PARK_XY_FEEDRATE 1000   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE    150   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
...
//
#define ENCODER_PULSES_PER_STEP 4	//[MDS]

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1	//[MDS]
