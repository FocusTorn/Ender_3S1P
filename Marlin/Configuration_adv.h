...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  26, 26 }, { 201,  26 }, { 201,203 }, { 26, 203 } }
...
#define SD_FINISHED_RELEASECOMMAND "G1 X0 Y200\nM84"   //"M84 X Y Z E" //rock_20210730
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 64 //[OP]
#else
...
#define RX_BUFFER_SIZE 2048  //[OP]

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF  //[OP]
#endif
 ...
 */
#define AUTO_REPORT_POSITION //[OP]
...
#define MEATPACK_ON_SERIAL_PORT_1 //[OP]
#define MEATPACK_ON_SERIAL_PORT_2 //[OP]
